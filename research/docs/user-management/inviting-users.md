...
> Invite collaborators from the workspace Users page, assign roles, and manage access over time.
...
Details on buttons and permissions: [Workspace Users page](/user-management/workspace-ui).
